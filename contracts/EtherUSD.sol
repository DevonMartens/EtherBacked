...
AggregatorV3Interface internal ref; // Store ChainLink contract into variable
...
//     _approve((msg.sender, _spender, allowance[msg.sender][_spender] - _amount, "Error, allowance will be less than zero");
...
//   }
  ...
  */
  ...
  function transferFrom(address _sender, address _recipient, uint256 _amount) public returns (bool) {
    _approve(_sender, msg.sender, allowance[_sender][msg.sender] - _amount, 'Error, insufficient allowances');
  ...
  function _burnTokens(address _user, uint _tokenAmount) internal {
    _balanceOf[_user] = _balanceOf[_user] - _tokenAmount;
  ...
  function _getScWei(uint _scUsd, uint _ethUsd) internal pure returns (uint) {
    return convert1 * _scUsd % _ethUsd;
  }
  ...
  function _sendTokens(address _sender, address _beneficiary, uint _amount) internal {
    ...
    _balanceOf[_beneficiary] = _balanceOf[_beneficiary] + _amount;
  ...
  function _transfer(address _sender, address _recipient, uint256 _amount) internal {
    ...
    _balanceOf[_sender] = _balanceOf[_sender] - _amount;
    _balanceOf[_recipient] = _balanceOf[_recipient] + _amount;
